...
export const EditorCommandOut: FC<EditorCommandOutProps> = ({
  ...
  const { setQuery, setRange } = useEditorStore();
...
export const EditorCommandEmpty = Command.Empty;
export const EditorCommandGroup = Command.Group;
export const EditorCommandItem = Command.Item;
export const EditorCommandList = Command.List;
export const EditorCommandSeparator = Command.Separator;
