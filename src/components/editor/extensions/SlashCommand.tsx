...
import { EditorCommandOut } from "../components/EditorCommand";
...
const renderItems = (elementRef?: RefObject<Element> | null) => {
  ...
  return {
    onStart: (props: { editor: Editor; clientRect: DOMRect }) => {
      ...
      // @ts-expect-error - tippy expects a DOM element but we're passing a function
      popup = tippy("body", {
    ...
    onKeyDown: (props: { event: KeyboardEvent }) => {
      ...
      // @ts-expect-error - component.ref might not have onKeyDown method
